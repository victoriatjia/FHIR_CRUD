/*
    ...
    @param：
        ...
        ReponseType： Requested data type returned by the server
...
*/
var totalPost; //used to store total of data user want to post
    ...
    xhttp.onreadystatechange = function () {
        ...
        */
        if (this.readyState == 4 && this.status == 201) {
            ...
            */
			totalPost--;
			if (totalPost>0) postResource(URL, ResourceName, Parameter, ResponseType, AfterFun, RequestData);
			else if (totalPost==0)
			{
				eval(AfterFun)(str);
				return str;
